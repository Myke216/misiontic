    ...
    public class AppContext: DbContext{
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder){
            if(!optionsBuilder.IsConfigured){
                ...
                optionsBuilder.UseSqlServer("Data Source = equipo9-grupo25.database.windows.net; Initial Catalog = ProyectoCiclo3; User ID=admin_equipo9_grupo25;Password=&$zBylOQEsc");
            }
        }
    }
}
